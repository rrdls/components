...
import { EdgesClipper, OrthoPerspectiveCamera } from "../../navigation";
...
export declare class FragmentPlans extends Component<PlanView[]> implements Disposable, UI {
    ...
    constructor(components: Components, clipper: EdgesClipper, camera: OrthoPerspectiveCamera);
    /** {@link Component.get} */
    get(): PlanView[];
